...
/**
 * Represents the ideals of a number field
 * @author karve
 */
public class Ideal extends Variable {
	...
	/**
	 * prime ideal factorization as returned by KASH
	 */
    ...
    /**
     * is this ideal integral?
     */
    private Boolean integral;
	/**
	 * temporarily holds generator string (see usages below)
	 */
	private String tempGen;
    /**
     * this ideals generators
     */
    private String generators;//we always want access to a 2-element rep. of the ideal
    /**
     * gnerators in power-basis rep.
     */
    ...
    /**
     * constructor
     * @param name KASH name
     * @param value eval string
     */
    ...
    /**
     * calls the KASH constructor for ideals
     * @param args KASH constructor argument(s)
     * @return resulting KASH string (e.g. Eval(Ideal(<CODE>args</CODE>))
     */
    ...
    /**
     * set the principality of this ideal to the given value
     * @param principal true, false, or unknown
     */
	...
	/**
	 * return generators in power basis rep.
	 * @return return generators in power basis rep.
	 */
	...
	/**
	 * set the generators to the value given by <CODE>tmp</CODE>
	 * @param tmp generators of this ideal
	 */
	...
	/**
	 * set the the temporary generators
	 * @param x temporary generators
	 * @see #tempGen
	 */
	...
	public boolean update() {
		...
		boolean trivial = tab.getInspector().getField().isUFD(); //class number 1
		if(start == '['){
	...
	/**
	 * 
	 * @param rep ideal class representative as returned by KASH
	 * @return typeset ideal class representative for this ideal
	 */
	...
	/**
	 * 
	 * @return TRUE, FALSE, or UNKNOWN depending on the principality of this ideal
	 */
	...
	/**
	 * 
	 * @return KASH variable name for the auto-captured generators of this ideal
	 */
	...
	/**
	 * regex pattern to match ideals (to a power) as output by KASH
	 */
	 ...
	 * @param powers include factor exponents in the return value?
